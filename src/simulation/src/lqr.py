...
class LQR(Node):
    ...
    def __init__(self):
        ...
        self.vel_pub = self.create_publisher(Twist, '/mobrob/cmd_vel', 10)
        self.vel = Twist()
        self.odom_sub = self.create_subscription(Odometry, '/mobrob/odom',self.odom_sub_callback, 10)
